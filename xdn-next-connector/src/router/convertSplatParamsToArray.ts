...
/**
 * Converts path params captured by [...varName] from a single string (the format returned by the XDN's router)
 * to arrays split by "/" (the format that Next.js provides).
 * @param {String} page The page route path
 * @param {Object} params The params captured by the XDN router
