...
import RazzleRoutes from '../../src/RazzleRoutes'

describe('RazzleRoutes.ts', () => {
  let originalDir, razzleRoutes, router, rules
  ...
  const init = () => {
    razzleRoutes = new RazzleRoutes()
    router = new Router().use(razzleRoutes)
    rules = router.rules
  }
