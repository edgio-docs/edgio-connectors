...
export default {
  ...
  '@nuxtjs/composition-api/module', '@nuxt/typescript-build', '@nuxtjs/style-resources', '@nuxtjs/google-fonts', // to core soon
  '@nuxtjs/pwa', [
  ...
  ], ['@vue-storefront/nuxt-theme'], "@layer0/nuxt/module", "@layer0/vue-storefront/module"],
  modules: [
    [
      'nuxt-i18n',
      {
