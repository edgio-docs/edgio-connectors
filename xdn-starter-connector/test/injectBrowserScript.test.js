...
describe('injectBrowserScript', () => {
  ...
  describe('production', () => {
    ...
    it('should add browser.js to the head', () => {
      ...
      expect(response.body).toMatch(
        `<!DOCTYPE html><html><head><script src="/__xdn__/${BUILD_ID}/browser.js" defer=""></script></head><body></body></html>`
      )
    })
  })
  ...
  describe('development', () => {
    ...
    it('should add browser.js to the head', () => {
      ...
      injectBrowserScript(response)
      expect(response.body).toMatch(
        '<!DOCTYPE html><html><head><script src="/__xdn__/development/browser.js" defer=""></script></head><body></body></html>'
      )
    })
