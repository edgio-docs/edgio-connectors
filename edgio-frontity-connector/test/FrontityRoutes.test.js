describe('FrontityRoutes', () => {
  let Router, cache, serveStatic, renderWithApp, request, response, FrontityRoutes
  ...
  describe('in production', () => {
    ...
    it('should serve static assets', async () => {
      ...
      await new Router().use(new FrontityRoutes()).run(request, response)
      expect(serveStatic).toHaveBeenCalledWith('build/static/:path*', { permanent: true })
