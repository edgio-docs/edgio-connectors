...
import FrontityRoutes from '../../src/FrontityRoutes'

describe('FrontityRoutes.ts', () => {
  let originalDir, frontityRoutes, router, rules
  ...
  const init = () => {
    frontityRoutes = new FrontityRoutes()
    router = new Router().use(frontityRoutes)
    rules = router.rules
  }
